      ...
      try {
        if (/^https?:\/\//.test(content)) {
          ...
          if (/image/i.test(mime)) {
            return sock.sendMessage(chat, { image: data.data, caption, ...options }, { quoted, ephemeralExpiration });
          } else if (/video/i.test(mime)) {
            return sock.sendMessage(chat, { video: data.data, caption, ...options }, { quoted, ephemeralExpiration });
          } else if (/audio/i.test(mime)) {
            return sock.sendMessage(chat, { audio: data.data, mimetype: mime, ...options }, { quoted, ephemeralExpiration });
          } else {
