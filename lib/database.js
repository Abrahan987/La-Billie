...
export function initDB() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS settings (
      ...
      nameid TEXT DEFAULT 'BILLIE EILISH BOT',
...
export default { initDB, getUser, setUser, getChat, setChat, getChatUser, setChatUser, getSettings, setSettings, getCharacter, setCharacter, getStickersPack, setStickersPack, deletedb, clearCache, db };
